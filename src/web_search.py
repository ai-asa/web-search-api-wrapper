...
class WebSearch:
    ...
    def _initialize_engines(self):
        ...
        from src.google_custom_search import get_search_response
        self.engines["google"] = {
            "instance": None,
        ...
        # Bing Web Search API
        from src.bing_web_search import BingWebSearch
        ...
        from src.duckduckgo_instant_answer import DuckDuckGoInstantAnswer
